...
APPROACH_PROXIMITY_SUCCESS_MM = 65.0            # target-whisker distance for goal success (mm)
...
YOLO_MODEL_PATH = '/home/me-cas-jetson04/Comp_Code_Team6/src/vision_processing_package/models/daedalus.engine'    # empty → fall back to daedalus.{engine,pt} in the vision package
