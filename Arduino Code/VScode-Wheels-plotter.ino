...
// CONFIGURATION
// ========================================================================
// Encoder pins (Channel A=interrupt, Channel B=sampled) {Correct as of May 3rd, 2026}
...
// Emit wheel telemetry in FL, FR, RL, RR order for the Arduino Serial Plotter.
// Measured wheel speed is used so the plot tracks the actual spinning motors.
void emitWheelTelemetry() {
  Serial.print(F("FL:"));
  Serial.print(measuredSpeedFL, 4);
  Serial.print(F(",FR:"));
  Serial.print(measuredSpeedFR, 4);
  Serial.print(F(",RL:"));
  Serial.print(measuredSpeedRL, 4);
  Serial.print(F(",RR:"));
  Serial.println(measuredSpeedRR, 4);
}
